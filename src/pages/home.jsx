    ...
    <div>
      <React.Fragment>
        ...
        <Container maxWidth="lg" sx={{py: 5}}>
          ...
          <Box sx={{bgcolor: '#FFFFFF', height: '110vh', 
          ...
          <Box>
            <Typography variant="h4" fontWeight="bold"
              sx={{ color:"#d32f2f", fontFamily: "Arial"}}>Quais os nossos serviços?
            </Typography>
          ...
          <Box sx={{bgcolor: '#FFFFFF', display:"flex", 
            ...
            <ButtonGroup variant="text" size='large' aria-label="button group" 
              ...
              <Button component={Link} to="/calculadora" sx={{ color:"#CC1F1F"}}>
                Calculadora</Button>
              <Button component={Link} to="/blog" sx={{ color:"#CC1F1F"}}>
                Blog</Button>
              <Button component={Link} to="/contato" sx={{ color:"#CC1F1F"}}>
